...
ZeroMscreenLineSink(ml,-5., -5.0, -5.,-4.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5., -4.0, -5.,-3.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5., -3.0, -5.,-2.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5., -2.0, -5.,-1.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5., -1.0, -5., 0.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5.,  0.0, -5., 1.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5.,  1.0, -5., 2.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5.,  2.0, -5., 3.0, 0.0, [1,2])
ZeroMscreenLineSink(ml,-5.,  3.0, -5., 4.0, 0.0, [1,2])
